...
(function (e) {
  ...
  e.fn.attr2 = function () {
    ...
    for (s = 0, m = o.length; m > s; s++) {
      if (f = o[s], l = f.name, l && !f.disabled) if (t && i.clk && "image" == f.type) i.clk == f && (a.push({
        name: l,
        value: e(f).val(),
        type: f.type
      }), a.push({
        ...
        name: l + ".y",
        value: i.clk_y
      }));else if (c = e.fieldValue(f, !0), c && c.constructor == Array) for (r && r.push(f), u = 0, p = c.length; p > u; u++) {
        a.push({
          name: l,
          value: c[u]
        });
        ...
        r && r.push(f);
        var d = f.files;
        if (d.length) for (u = 0; d.length > u; u++) {
          a.push({
            name: l,
            value: d[u],
            type: f.type
