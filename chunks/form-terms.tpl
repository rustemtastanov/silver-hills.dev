<app-form inline-template :form-utm="UTM" v-on:show-response="showResponse" v-on:hide-response="hideResponse">
	<form action="/" class="form-terms" id="formTerms" :data-error="hasError" :data-loading="isLoading" @submit.prevent="submit()" novalidate>
	    <input type="hidden" name="terms" value="order" />
		...
		<div class="form-controls">
			<button type="submit" class="btn btn--fill btn--submit btn--block btn--primary">
